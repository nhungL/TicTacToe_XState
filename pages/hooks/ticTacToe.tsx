...
export const TicTacToe = () => {
    ...
    // const { send: dispatch } = service
    console.log(service)
    // const boardSize = useSelector(service, (state) => {
    //     return state.context.size;
    //   });
    //   console.log(boardSize)
    // const boardSize = props.context
  // return (
  //     <div>in Tic tac toe components</div>
  // );
  //   // const [current, send] = useMachine(ticTacToeMachine);
  //   const service = useContext(TTTContext);
  //   const [state] = useActor(service.authService);
